...
pub const COMMANDS: &[(&str, Action)] = &[
    ...
    ("new endpoint (choose location)", Action::NewEndpointPick),
    (
    ...
    ("reorder up", Action::MoveUp),
    ("reorder down", Action::MoveDown),
    ...
    ("new sequence", Action::NewSequence),
    ...
    ("close all buffers", Action::BufferCloseAll),
